...
! ***********************************************************************
      ...
      subroutine data_for_extra_profile_columns(id, n, nz, names, vals, ierr)
         ...
         real(dp) :: vals(nz,n)
         real(dp) :: kap, dlnkap_dlnRho, dlnkap_dlnT, sig 
         real(dp), dimension(:), allocatable :: kap_cond
         integer, intent(out) :: ierr
         type (star_info), pointer :: s
         integer :: k, kmax
         ...
         names(3) = 'magnetic_diffusivity'
         names(4) = 'electric_conductivity'
         max_frac = 0d0
         kmax = 0

         allocate(kap_cond(nz)) 
         ...
         do k=1,s% nz
            ...
            ! First calculate electric conductivity
            ...
            ! and the magnetic diffusivity
             ...
             vals(k,3) = clight * clight / (4d0 * pi * sig)
